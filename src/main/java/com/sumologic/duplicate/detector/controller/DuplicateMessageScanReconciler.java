...
import com.sumologic.duplicate.detector.controller.customresource.SingleDuplicateMessageScanStatus;
...
public class DuplicateMessageScanReconciler implements Reconciler<SingleDuplicateMessageScan>, ErrorStatusHandler<SingleDuplicateMessageScan> {
  @Override
  public UpdateControl<SingleDuplicateMessageScan> reconcile(SingleDuplicateMessageScan scan,
    ...
    return UpdateControl.patchStatus(scan.withStatus(
      new SingleDuplicateMessageScanStatus(context.getSecondaryResource(Job.class).orElseThrow().getStatus())));
  }
  ...
  public ErrorStatusUpdateControl<SingleDuplicateMessageScan> updateErrorStatus(SingleDuplicateMessageScan resource,
                                                                                ...
                                                                                Exception e) {
    return ErrorStatusUpdateControl.patchStatus(resource.withStatus(new SingleDuplicateMessageScanStatus(e)));
  }
}
